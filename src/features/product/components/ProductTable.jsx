...
const ProductTable = () => {
  ...
  return (
    <section>
      <div className=" sm:flex justify-between mb-3 px-5">
         <div className=" sm:order-1">
          <Link
            to="/dashboard/product-create"
            type="button"
            className="text-white gap-2 bg-blue-700 hover:bg-be-lu800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-[12px] sm:text-base px-5 py-2.5 me-2 mb-2 flex items-center"
          >
            Add new product
            <HiPlus />
          </Link>
        ...
        <div className=" sm:order-0">
          <div className="relative mb-6">
            ...
            <input
              ...
              className="bg-gray-50 border border-gray-300 text-gray-900 text-[12px] sm:text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div className="relative overflow-x-auto shadow-sm mb-5 sm:rounded-lg">
        <table className="w-full text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
          <thead className="text-[8px] md:text-sm text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className="px-2 py-2 sm:px-6 sm:py-3 text-end">
